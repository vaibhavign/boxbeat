...
<!-- Floating Div
<div id="floatMenu" class="clearBoth default_bar" style="position: absolute; top: 281px;">
	<div class="lh5">&nbsp;</div>
	<div class="container">
		<div id="bar_class" class=" floatLeft main_heading" style="width:200px; background-color:#FFF;">Optimize</div>    

		<div class="floatRight">
                	<div class="floatLeft"><input type="image" src="/images/addcategory/save_btn.png" alt="Save" title="Save" id="save" class="validateData"/></div>
                    <div class="wid11">&nbsp;</div>
                	<div class="floatLeft <?php echo $edata ?>"<?php if(($param=='saveContinue validateData')||($edata=='saveContinueDisable')){echo 'title="Save &amp; Continue"'.' id="savecontinue"';}else if(($edata=='saveExit validateData')||($edata=='saveExitDisable')){echo 'title="Save &amp; Exit"'.' id="saveexit"';}?>>&nbsp;</div>
                    <div class="wid11">&nbsp;</div>
                    <div class="floatLeft close" id="close"><input type="image" src="/images/addcategory/cross_btn.png" alt="Close" title="Close" /></div>	
                </div>
	 </div>
</div>
 Floting Div-->