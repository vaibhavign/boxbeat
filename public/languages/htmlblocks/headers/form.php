...
switch ($actionName) {
	case 'manageforms':
		$moduleName = "Forms";
		$text = "Forms allow you to obtain information from the customers by using your form on the store front.";
		$displayrightblock = true;
		$rightblockGap = true;
		$rightblockGapCode = '<div class="subheaderheadingGap">&nbsp;</div>';
		$rightblocktext = '<a href="/admin/form/#fillforminfo"><img title="Add a Form" src="/images/admin/form/add_a_form_btn.jpg"/></a>';
		break;
	...
	case 'assignlabel':	
		...
		$displayrightblock = true;		
	case 'formdetail':
		$moduleName = "Form Details";
		$text = "View the detailed information of your form.";
		$displayrightblock = false;		
	break;	
}
?>
