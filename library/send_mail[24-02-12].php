...
echo "Test WWWWWWWWWW";
            ...
            case '58':      //confirm shipment from seller to buyer
                $this->toMailInfo('SET-INFO', array('to_id' => $data_arr['orderData']['buyer_id'], 'to_mail' => $data_arr['orderData']['buyer_email'], 'to_name' => $data_arr['orderData']['buyer_name']));
                $this->fromMailInfo('SET-INFO', array('from_id' => $data_arr['orderData']['seller_id'], 'from_mail' => $data_arr['orderData']['seller_email'], 'from_name' => $data_arr['orderData'][0]['seller_mall_title']));
                $this->ph = array(
