...
echo "Test WWWWWWWWWW";
            ...
            case '58':      //confirm shipment from seller to buyer
                ...
                $this->fromMailInfo('SET-INFO', array('from_id' => $data_arr['orderData']['seller_id'], 'from_mail' => $data_arr['orderData']['seller_email'], 'from_name' => $data_arr['orderData']['seller_name']));
                $this->ph = array(
