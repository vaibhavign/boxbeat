								...
								<div class="blockcontent">
									...
									{if $compare_products_array|@sizeof eq 0}
									  ...
									  {foreach from=$compare_products_array item=product}
										  <div class="main_container">
												<div class="clearBoth">
													<div class="icon"><a href="javascript://"><span id="{$product.id}" class="delete_icon" title="Delete"></span></a></div>
													<p class="image">
									...
									{if $compare_products_array|@sizeof neq 0}
										 ...
										 <div class="buttons">
											<div class="compare_btn"><a href = "http://{$smarty.server.HTTP_HOST}/compareall"><input type="image" src="{$image_path}compare_btn.png" alt="Compare all" /></a></div>
											<div class="clearall_btn"><input type="image" src="{$image_path}clearall_btn.png" alt="Clear all" /></div>
										 </div> 
