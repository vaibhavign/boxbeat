                          ...
                          <h2>
							...
							<div class="blockcontent">
							  <ol class="grid">
								...
								<li>
								  <h4>
									<div class="gridtitle"><a href="{$product.url}" title="{$product.title}">{$product.title|@stripslashes}</a></div>
								  </h4>
								  <p class="image"> <a href="{$product.url}" title="{$product.title}"><img src="{$product.image}" alt="{$product.image_title}" title="{$product.image_title}"/></a> </p>
								  <div class="container">
									<div class="icon_container"> <a href="{$product.url}" class="cart_icon" title="Add to cart"></a> <a href="javascript://" rel="{$product.id}" class="compare_icon" title="Add to compare"></a> <a href="javascript://" rel="{$product.id}" class="wishlist_icon" title="Add to wishlilst"></a> </div>
									<h4>
