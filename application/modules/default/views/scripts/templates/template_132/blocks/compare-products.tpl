								...
								<div class="blockcontent">
									...
									{if $compare_products_array|@sizeof eq 0}
									  ...
									  {foreach from=$compare_products_array item=product}
										  <div class="main_container">
												<div class="clearBoth">
													<div class="icon"><a href="javascript://" title="Delete"><span id="{$product.id}" class="delete_icon"></span></a></div>
													<p class="image">
													   <a href="{$product.url}" title="{$product.image_title}"><img src="{$product.image}" alt="{$product.image_title}" title="{$product.image_title}"/></a>
													</p>
													<div class="container">
													...
													<div class="product">
														...
														<div class="delete_icon" title="Delete"><a class="delete" id="{$product.id}" href="javascript://"></a></div>
													</div>
												</div>
											</div>
									...
									{if $compare_products_array|@sizeof neq 0}
										 ...
										 <div class="buttons">
											...
											<div class="clearall_btn"><input type="image" alt="Clear all" title="Clear all" src="{$image_path}clearall_btn.png" /></div>
										 </div> 
