                      ...
                      <h2> <div class="blocktitle">Compare Products</div></h2>
                            <div class="blockcontent">
								...
								{if $compare_products_array|@sizeof eq 0}
								  ...
								  {foreach from=$compare_products_array item=product}
									  <div class="main_container">
											<div class="clearBoth">
												<div class="icon"><a href="#"><span id="{$product.id}" class="delete_icon"></span></a></div>
												<p class="image">
												...
												<div class="product">
													...
													<div class="delete_icon"><a class="delete" id="{$product.id}" href="#"></a></div>
												</div>
											</div>
										</div>
								...
								{if $compare_products_array|@sizeof neq 0}
									 ...
									 <div class="buttons">
										<div class="compare_btn"><a href = "http://{$smarty.server.HTTP_HOST}/compareall"><input type="image" src="{$image_path}compare_btn.png" /></a></div>
										<div class="clearall_btn actionlink"><a id="All" href="javascript://">Clearall</a></div>
									 </div> 
