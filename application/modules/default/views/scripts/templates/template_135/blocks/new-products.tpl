							...
							<div class="blockcontent">
							  <ol class="grid">
								...
								<li>
								  ...
								  <div class="container">
									<div class="icon_container"> <a href="{$product.url}" class="cart_icon" title="Add to cart"></a> <a href="javascript://" rel="{$product.id}" class="compare_icon" title="Add to wishlilst"></a> <a href="javascript://" rel="{$product.id}" class="wishlist_icon" title="Add to compare"></a> </div>
									<h4>
