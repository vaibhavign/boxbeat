									...
									{if $compare_products_array|@sizeof eq 0}
									  ...
									  {foreach from=$compare_products_array item=product}
										  <div class="main_container">
												<div class="clearBoth">
													<div class="icon"><a href="javascript://" title="{$product.title}"><span id="{$product.id}" class="delete_icon"></span></a></div>
													<p class="image">
													...
													<div class="product">
														...
														<div class="delete_icon"><a class="delete" id="{$product.id}" href="javascript://"></a></div>
													</div>
												</div>
											</div>
